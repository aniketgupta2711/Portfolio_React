...
function Skills() {
  ...
  return (
    ...
    <div>
     <h1 className='text-3xl font-bold mb-12 text-purple-500 flex justify-center underline'>Skills</h1>
    
    <div className='grid grid-cols-1 md:grid-cols-4 gap-3 my-5 flexjustify-items-center'>
        {
            cardItem.map(({id,logo,name,char}) =>(
                <div className='md:w-75 md:h-75 border border-gray-600 bg-gray-900 rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300 flex flex-col items-center justify-center' key={id}>
