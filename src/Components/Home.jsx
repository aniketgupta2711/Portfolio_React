...
/>
    ...
    <span className='md:w-1/2 md:ml-65 md:mt-20 mt-8 order-1 flex justify-center' >
    <img  src="/ani1.jpeg" 
  alt="Profile" className='w-65 h-65 rounded-full md:w-102.5 md:h-102.5 border-2 border-purple-600 ' alt="" />
    </span>
    </div>
   </div>
